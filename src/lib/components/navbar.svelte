		...
		<nav class="nav nav-header">
			...
			<div class="centred flex gap-4 w-full relative">
				<div class="flex absolute right-0 gap-4">
					...
					<button on:click={toggleDarkMode} class="button flex z-2">
						<svg
					...
					<div class="flex centred lg:hidden">
						<button id="hamburger-button" class="button-blank centred flex z-2" on:click={toggleMenu}>
							<svg
								id="plus"
								width="24"
								height="24"
